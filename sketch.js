...
var star, star2, star_img, star_display, star_empty, oneStar, twoStar;
let numStars = 0;
...
function setup() 
{
  ...
  star2 = createSprite(450,220,20,20);
  star2.addImage(star_img);
  star2.scale = 0.02;

  brower = createImg('baloon2.png');
  brower.position(260,370);
  brower.size(120,150);
  brower.mouseClicked(airBlow);

  brower2 = createImg('balloon.png');
  brower2.position(120,150);
  brower2.size(150,150);
  brower2.mouseClicked(airBlow2);
